export default {
    'zh-CN': {
        ...
        tip: '注：只是为了示范如何实现多语言切换，所以只对当前页做了翻译。',
    ...
    'zh-TW': {
        ...
        tip: '注：只是為了示範如何實現多語言切換，所以只對當前頁做了翻譯。',
    ...
    'en-US': {
        ...
        tip: 'Note: just to demonstrate how to achieve multi-language switching, so only the current page to do the translation.',
